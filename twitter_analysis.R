...
wd <- 'path of your local working directory'
setwd(wd)
...
terms <- c("gempa palu", "#gempapalu","#gempadongala","#savepalu","#gempadantsunamipalu","#tsunamipalu","tsunami palu","#palubangkit",
           "#gempasulteng","gempa sulteng","#prayforpalu")
